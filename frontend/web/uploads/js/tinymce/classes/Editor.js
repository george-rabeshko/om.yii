...
define("tinymce/Editor", [
	...
	Editor.prototype = {
		...
		init: function() {
			...
			// IE8 doesn't support carets behind source setting ie7_compat would force IE8+ to run in IE7 compat mode.
		...
		/**
		 * Uploads all data uri/blob uri source in the editor contents to server.
		 *
		 * @method uploadImages
		 * @param {function} callback Optional callback with source and status for each image.
