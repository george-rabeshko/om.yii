...
#                     $magicianObj = new resize('source/car.jpg');
#                     $magicianObj -> resizeImage(150, 100, 0);
#                     $magicianObj -> saveImage('source/car_small.jpg', 100);
#
...
#              * Minor bug fixes
#  26-07-11  J.C.O   0.1.4 * Added support for external source
...
#  parameter. If disabled, if an source original size is smaller than the size
#  specified by the user, the original size will be used. This is useful when
#  dealing with small source.
#
#  If enabled, source smaller than the size specified will be stretched to
#  that size.
#
#  Tips:
# -------------------------------
...
#      - Force stretching of smaller source (upscale)
#    * APPLY FILTERS
...
#
# These are inteded to be applied to thumbnail source.
#
...
## --------------------------------------------------------
	...
	public function displayImage($fileType = 'jpg', $imageQuality = "100")
		# Author:     Jarrod Oberto
		# Date:       18-11-09
		# Purpose:    Display source directly to the browser
...
## --------------------------------------------------------
	...
	{
		// *** making source with white bg transparent
		$r1 = 0;
		$g1 = 255;
		$b1 = 0;
 ...
 *
 *      // *** Initialise object
 *      $magicianObj = new resize('source/cars/large/a.jpg');
 *
 ...
 *
 *      // *** Save image to disk
 *      $magicianObj -> saveImage('source/cars/large/b.jpg', 100);
 *
